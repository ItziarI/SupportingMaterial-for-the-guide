...
- **FMW I : log(p/1-p) versus PRS.i + Sex + Diagnostic + Age + PC1 + PC2**
- **FMSex: log(p/1-p) versus PRS.i + Sex + PRS.i ·Sex + Diagnostic + Age + PC1 + PC2**
- **FMDiagnostic: log(p/1-p) versus PRS.i + Sex + Diagnostic +    PRS.i · Diagnostic + Age + PC1 + PC2**
- **FMSex/Diagnostic: log(p/1-p) versus PRS.i + Sex + PRS.i · Sex + Diagnostic + PRS.i · Diagnostic + Age + PC1 + PC2**
