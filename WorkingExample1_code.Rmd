...
### The plots suggest that the interaction between the PRS.4 and the diagnostic is relevant. Thus, we set the full model candidate (FM): $Trait \sim PRS + Sex + Diagnostic + PRS\cdot Diagnostic + PC1 +PC2$
